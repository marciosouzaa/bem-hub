      ...
      <section className="min-w-0 space-y-6">
        <MotionSection className="py-4">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-strong">
            Seu workspace está pronto para operar assistentes, conversas e
            documentos com isolamento por organização.
          </p>
        </MotionSection>
          ...
          <MotionSurface>
            <Card>
              <CardHeader className="flex-row items-center justify-between space-y-0">
                ...
                <Link className="text-xs font-medium text-primary" href="/app/chat">
                  Abrir chat
                </Link>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div className="flex items-center gap-4">
                ...
                <CardTitle className="text-2xl">Conversas recentes</CardTitle>
              </div>
              ...
              {recentConversations.map(({ icon: Icon, title, excerpt, time }) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-xs text-muted">{excerpt}</p>
                  </div>
          ...
          <Card className="os-grid overflow-hidden">
            <CardContent className="p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-strong">
                A base documental entra na próxima fase do MVP, depois do chat
                persistente com fontes.
              </p>
