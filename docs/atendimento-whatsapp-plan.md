...
- [x] aplicar as migrations de ciclo operacional e outbox/retry;
- [ ] concluir separacao entre review e delivery;
- [x] preparar indices, unicidade, RLS e RPCs atomicas do ciclo operacional;
- backfill seguro dos rascunhos existentes;
- [x] executar probes transacionais com duas organizacoes no banco configurado;
- [ ] executar a suite pgTAP completa.
...
- [x] aplicar/validar o ciclo;
- [ ] adicionar transferencia simples por seletor;
